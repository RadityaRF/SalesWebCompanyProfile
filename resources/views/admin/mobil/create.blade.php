...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        <h2 class="text-xl sm:text-2xl font-semibold text-gray-800">Tambah Mobil</h2>
    </div>
    ...
    <form action="{{ route('admin.mobil.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
        @csrf
